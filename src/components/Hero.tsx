        ...
        return <div id="hero" className="container-fluid min-vh d-flex justify-content-center align-items-center p-5">
            <div className="row hero-div pt-5">
                <div className="container-fluid d-flex align-items-center mb-5">
                    {!loaded && <div className="profile-pic-loading d-flex justify-content-center align-items-center" ><img src="/icons/loading.gif" alt="loading" width={50} height={50}/></div>}
                ...
                <div className="roboto-regular fs-5">
                    I am currently a computer science graduate student at the School of Information Technology, KMUTT,
